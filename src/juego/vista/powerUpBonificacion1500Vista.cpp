...
PowerUpBonificacion1500Vista::~PowerUpBonificacion1500Vista() { }

PowerUpBonificacion1500Vista::PowerUpBonificacion1500Vista() {
    this->figuraPowerUp = new Figura();
    this->pathSprite = SPRITE_POWERUP_BONIFICACION_1500;
...
void PowerUpBonificacion1500Vista::render(float posX, float posY, int estadoAnimacion, SDL_Renderer *renderer) {
