...
void EscenarioVista::inicializarComponentes(string infoEscenario) {
    ...
    this->agregarAvionSecundarioVista();
...
void EscenarioVista::agregarAvionSecundarioVista(){
    // TODO Por ahora le pasamos 0,0... despues vamos a ver algo un poco mas elegante (?)
    this->avionSecundarioVista = new AvionSecundarioVista(0,0);
}
...
void EscenarioVista::cargarVistaAvionesSecundarios() {
    this->avionSecundarioVista->cargarImagen(this->ventana->getVentanaRenderer());
}
...
void EscenarioVista::renderizarAviones() {
    ...
    // cout << "POS AVION VISTA EN Y: " << avionDelCliente->getPosY() << endl;
