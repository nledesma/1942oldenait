...
void Colisionable::crearAvionMediano(float posX, float posY, float angulo){
    ...
    this->superficiePrincipal->rotar(angulo, xCentro, yCentro);
    Superficie * superficie1 = new Superficie(posX, posY, AVION_ENEMIGO_MEDIANO_ANCHO_1, AVION_ENEMIGO_MEDIANO_ALTO_1, OFFSET_AVION_ENEMIGO_ANCHO_1 + OFFSET_ANCHO_AVION_MEDIANO_DEFAULT, OFFSET_ALTO_AVION_MEDIANO_DEFAULT);
    Superficie * superficie2 = new Superficie(posX, posY, AVION_ENEMIGO_MEDIANO_ANCHO_2, AVION_ENEMIGO_MEDIANO_ALTO_2, OFFSET_AVION_ENEMIGO_ANCHO_1 + OFFSET_ANCHO_AVION_MEDIANO_DEFAULT, OFFSET_ALTO_AVION_MEDIANO_DEFAULT);
    Superficie * superficie3 = new Superficie(posX, posY, AVION_ENEMIGO_MEDIANO_ANCHO_1, AVION_ENEMIGO_MEDIANO_ALTO_1, OFFSET_ANCHO_AVION_MEDIANO_DEFAULT, OFFSET_ALTO_AVION_MEDIANO_DEFAULT);
    superficie1->rotar(angulo, xCentro, yCentro);
    superficie2->rotar(angulo, xCentro, yCentro);
    superficie3->rotar(angulo, xCentro, yCentro);
    this->superficiesSecundarias.push_back(superficie1);
